...
{
	DIO_ERROR_NONE,
	DIO_ERROR_INVALID_PORT,
	DIO_ERROR_INVALID_PIN_NUMBER,
	DIO_ERROR_INVALID_DIRECTION,
	DIO_ERROR_INVALID_DIGITAL_VALUE,
	DIO_ERROR_INVALID_INTERRUPT_TYPE,
	DIO_ERROR_INVALID_EXTERNAL_INTERRUPT_SENSE
} EN_DIOErrorStatus_t;
